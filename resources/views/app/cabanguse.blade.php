                    ...
                    <!-- <p class="section-lead">Silahkan Masukkan Detail Nama Barang dan Satuannya yang nantinya digunakan untuk data barang.</p> -->
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card">
                                <form action="/cabang/{{$data->id_gudang_brg}}" method="post" role="form">
                                        {{csrf_field()}}
                                    <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">    
                                            ...
                                            <input type="text" class="form-control" name="jmllama"  value="{{$data->jml}}" id="jmllama" readonly>
                                        </div>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">    
                                            ...
                                            <input type="number" class="form-control" placeholder="Jumlah Stok Keluar" name="jmlkeluar" max="{{$data->jml}}" required>
                                        </div>
                                        </div>
