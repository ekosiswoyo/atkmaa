        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-body">
                    ...
                    <p class="section-lead">Silahkan Masukkan Nama Satuan yang nantinya digunakan untuk satuan barang.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">    
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukkan ID Satuan" name="id_satuan" value="{{$id_satuan}}" readonly>
                                        </div>
