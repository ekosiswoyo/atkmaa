                                            ...
                                            <div class="card-body">
                                                ...
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="/trans/{{$datas->id_gudang_brg}}/edit"><button type="button" class="btn btn-info">STOK MASUK</button></a>&nbsp;<a href="/transcab/{{$datas->id_gudang_brg}}/editcab"><button type="button" class="btn btn-warning">STOK KELUAR</button></a></td>
                                                    </tr>
                                                    @endforeach
